...
window.Chat = (() => {
  ...
  const PRESENCE_STALE_MS = 20000; // consider someone "offline" if their heartbeat is older than this
  const HEARTBEAT_MS = 8000;
  const MAX_MESSAGES = 200; // trim how many messages we keep/display
